...
import { type RankedRestaurant } from '@/lib/rankRestaurants';
...
export default function RecommendPage() {
  ...
  const handleNavigate = useCallback((restaurant: RankedRestaurant, rank: number) => {
    void fetch('/api/history/navigation', {
      method: 'POST',
      ...
      <div className="flex-1 flex flex-col w-full overflow-hidden relative">
        ...
        {uiState === 'results' && (
          <div className="flex-1 flex flex-col w-full overflow-hidden">
            ...
            <ResultsList restaurants={results} onNavigate={handleNavigate} />
